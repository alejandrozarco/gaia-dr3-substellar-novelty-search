...
MAGRE = re.compile(r"DQ|DAQ|hot ?DQ|carbon|\bQ\b", re.I)
out = {}
for gid in ids:
    r = g.loc[gid]; res = {}
    ...
    try:
        ...
        res["vizier"] = dict(n_tables=len(tl), dq_type_hits=hits[:10])
...
json.dump(out, open("gate_dq.json", "w"), indent=1, default=str)
