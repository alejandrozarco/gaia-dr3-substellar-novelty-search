...
RA, DE = 35.01897808991266, 63.06656439951715
c = SkyCoord(RA*u.deg, DE*u.deg)
ra, de = RA - 11.74*5/3.6e6/np.cos(np.radians(DE)), DE + 38.93*5/3.6e6
...
P0 = 0.0990842
grid = P0 + np.linspace(-3e-6, 3e-6, 60001)
...
json.dump(dict(P=P, T0=T0), open("j0220_ephem.json", "w"))
