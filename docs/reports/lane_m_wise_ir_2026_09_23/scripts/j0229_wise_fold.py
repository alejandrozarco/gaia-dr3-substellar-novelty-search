...
RA0, DE0, PMRA, PMDE = 37.45358, 75.52392, 28.6, -14.1
...
ax[3].set_xlabel(f"orbital phase (mid-eclipse BJD_TDB {T0:.5f}, P = {P:.9f} d)"); ax[0].set_title("Gaia DR3 548694338491992960 (WISE J022948.85+753126.0), 225 pc", fontsize=10)
plt.tight_layout(); plt.savefig("j0229_fold.png", dpi=130); print("figure written")
