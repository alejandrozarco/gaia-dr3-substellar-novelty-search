# Figure for VarWISE J075330.99-004209.7 = Gaia DR3 3082614748370926848 (lane M extension flag, 2026-09-23).
...
# per-visit W1 mean and semi-amplitude vs time. Output: j0753_fig.png, j0753_lc.csv (self-describing header).
...
with open("../data/j0753_neowise_lc.csv", "w") as fh:
    fh.write("# VarWISE J075330.99-004209.7 = Gaia DR3 3082614748370926848; NEOWISE-R single exposures, clean cuts as lane M; mjd (UTC), Vega mags\n")
...
a.axhline(15.406, color="tab:blue", ls="--", lw=1, label="AllWISE 2010 W1 15.41"); a.axhline(14.998, color="tab:green", ls=":", lw=1, label="CatWISE 2010-18 W1 15.00")
...
fig.suptitle("VarWISE J075330.99-004209.7 = Gaia DR3 3082614748370926848; P = 0.1053647 d (2.529 h)", fontsize=10)
plt.tight_layout(); plt.savefig("../figures/j0753_fold.png", dpi=115); print("saved; n W1", len(t), "n ZTF", len(Z))
