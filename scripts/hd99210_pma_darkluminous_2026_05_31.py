...
Gaia DR3 3790548130392339072 = HD 99210 (2026-05-31).

Caller context: HGCA chi2=128.9, Kervella snrPMa=19.85, M2_median (Kervella
M2_5AU MC) = 2.228 Msun, SIMBAD HD 99210, known_multiple=false. This is a PMa /
...
*conspicuous* unless the primary itself is far more luminous. So:
  ...
  (4) Is Kervella M2_5AU=2.228 + HGCA chi2=128.9 consistent with a *luminous*
      stellar companion of that mass, or does a DARK companion remain required?
      Decisive cross-check: the M2~2.23 Msun A-star's delta-G vs the primary and
...
Outputs: /tmp/hd99210_pma.json , /tmp/hd99210_pma_report.md
...
SID = 3790548130392339072
HD_NAME = 'HD 99210'
CALLER = dict(HGCA_chi2=128.9, snrPMa=19.85, M2_median=2.228, known_multiple=False)
...
def run():
    ...
    # M2_median (caller) = 2.228 -> approx A2-A5V (Teff~8000-8800, R~1.8-2.05).
    ...
    with open('/tmp/hd99210_pma.json', 'w') as f:
